    ...
    <div>
      ...
      <ScrollAnimation animateIn="fadeInLeft" animateOnce={true} duration={2} className="section">
        <div className="container service">
          ...
          <img src="https://tumhompl.sirv.com/Images/blueepoxy.jpg" width="750" height="750" alt="" />
        </div>
      </ScrollAnimation>
      <ScrollAnimation animateIn="fadeInRight" animateOnce={true} duration={2} className="section">
        <div className="container service">
          ...
          <img src="https://tumhompl.sirv.com/Images/stampedconcrete.jpg" width="512" height="418" alt="" />
        </div>
      </ScrollAnimation>
      <ScrollAnimation animateIn="fadeInLeft" animateOnce={true} duration={2} className="section">
        <div className="container service">
          ...
          <img src="https://tumhompl.sirv.com/Images/AdobeStock_132997610.jpeg" width="800" height="400" alt="" />
        </div>
      </ScrollAnimation>
      <ScrollAnimation animateIn="fadeInRight" animateOnce={true} duration={2} className="section">
        <div className="container service">
          ...
          <img src="https://tumhompl.sirv.com/Images/AdobeStock_75720252.jpeg" width="800" height="600" alt="" />
        </div>
      </ScrollAnimation>
    </div>
  )
